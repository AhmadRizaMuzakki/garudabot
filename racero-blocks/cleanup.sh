...
# Script for cleaning up blockly-specific files when merging blockly into racero-blocks
# Removes files and directories that racero-blocks doesn't want.
# Rachel Fenichel (fenichel@google.com)

# Note: 'ours' is racero-blocks, 'theirs' is blockly.
...
empty_lines
echo Cleaning up a merge from Blockly to Racero-Blocks...
...
# Racero-blocks does not use generators
empty_lines
...
# Racero-blocks has separate vertical and horizontal playgrounds and block
# rendering.
