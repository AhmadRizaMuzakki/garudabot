...
#   blocks_horizontal_compressed.js: The compressed Racero horizontal blocks.
#   blocks_vertical_compressed.js: The compressed Racero vertical blocks.
...
class Gen_compressed(threading.Thread):
  ...
  def do_compile_local(self, params, target_filename):
      ...
      # --- WINDOWS RESPONSE FILE FIX ---
      arg_file = target_filename + ".args.txt"
      with open(arg_file, 'w') as f:
          for arg in dash_args:
              f.write(arg + '\n')

      # The command now only has TWO parts: the compiler and the file pointer
      final_args = [CLOSURE_COMPILER_NPM, "@" + arg_file]

      print("Compiling " + target_filename + " with response file...")
      proc = subprocess.Popen(final_args, stdin=subprocess.PIPE, stdout=subprocess.PIPE)
      # ---------------------------------
