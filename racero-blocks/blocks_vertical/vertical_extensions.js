...
/**
 * @fileoverview Extensions for vertical blocks in racero-blocks.
 * The following extensions can be used to describe a block in Racero terms.
...
goog.provide('Blockly.RaceroBlocks.VerticalExtensions');
 ...
 *     category.
 */
Blockly.RaceroBlocks.VerticalExtensions.colourHelper = function(category) {
 ...
 */
Blockly.RaceroBlocks.VerticalExtensions.COLOUR_TEXTFIELD = function() {
 ...
 * @readonly
 */
Blockly.RaceroBlocks.VerticalExtensions.SHAPE_STATEMENT = function() {
 ...
 * @readonly
 */
Blockly.RaceroBlocks.VerticalExtensions.SHAPE_HAT = function() {
  this.setInputsInline(true);
  this.setNextStatement(true, null);
};
 ...
 * @readonly
 */
Blockly.RaceroBlocks.VerticalExtensions.SHAPE_END = function() {
  this.setInputsInline(true);
  this.setPreviousStatement(true, null);
};

/**
 * Extension to make represent a number reporter in Racero-Blocks.
 * That means the block has inline inputs, a round output shape, and a 'Number'
 * output type.
 * @this {Blockly.Block}
 * @readonly
 */
Blockly.RaceroBlocks.VerticalExtensions.OUTPUT_NUMBER = function() {
  this.setInputsInline(true);
...
/**
 * Extension to make represent a string reporter in Racero-Blocks.
 * That means the block has inline inputs, a round output shape, and a 'String'
 * output type.
 * @this {Blockly.Block}
 * @readonly
 */
Blockly.RaceroBlocks.VerticalExtensions.OUTPUT_STRING = function() {
  this.setInputsInline(true);
  this.setOutputShape(Blockly.OUTPUT_SHAPE_ROUND);
...
/**
 * Extension to make represent a boolean reporter in Racero-Blocks.
 * That means the block has inline inputs, a round output shape, and a 'Boolean'
 * output type.
 * @this {Blockly.Block}
 * @readonly
 */
Blockly.RaceroBlocks.VerticalExtensions.OUTPUT_BOOLEAN = function() {
  this.setInputsInline(true);
 ...
 * @readonly
 */
Blockly.RaceroBlocks.VerticalExtensions.PROCEDURE_DEF_CONTEXTMENU = {
  /**
 ...
 * @readonly
 */
Blockly.RaceroBlocks.VerticalExtensions.PROCEDURE_CALL_CONTEXTMENU = {
  /**
...
Blockly.RaceroBlocks.VerticalExtensions.SCRATCH_EXTENSION = function() {
  this.isRaceroExtension = true;
};
/**
 * Register all extensions for racero-blocks.
 * @package
 */
Blockly.RaceroBlocks.VerticalExtensions.registerAll = function() {
  var categoryNames =
  ...
  for (var i = 0; i < categoryNames.length; i++) {
    ...
    Blockly.Extensions.register('colours_' + name,
        Blockly.RaceroBlocks.VerticalExtensions.colourHelper(name));
  }

  // Text fields transcend categories.
  Blockly.Extensions.register('colours_textfield',
      Blockly.RaceroBlocks.VerticalExtensions.COLOUR_TEXTFIELD);

  // Register extensions for common block shapes.
  Blockly.Extensions.register('shape_statement',
      Blockly.RaceroBlocks.VerticalExtensions.SHAPE_STATEMENT);
  Blockly.Extensions.register('shape_hat',
      Blockly.RaceroBlocks.VerticalExtensions.SHAPE_HAT);
  Blockly.Extensions.register('shape_end',
      Blockly.RaceroBlocks.VerticalExtensions.SHAPE_END);

  // Output shapes and types are related.
  Blockly.Extensions.register('output_number',
      Blockly.RaceroBlocks.VerticalExtensions.OUTPUT_NUMBER);
  Blockly.Extensions.register('output_string',
      Blockly.RaceroBlocks.VerticalExtensions.OUTPUT_STRING);
  Blockly.Extensions.register('output_boolean',
      Blockly.RaceroBlocks.VerticalExtensions.OUTPUT_BOOLEAN);
  ...
  Blockly.Extensions.register('scratch_extension',
      Blockly.RaceroBlocks.VerticalExtensions.SCRATCH_EXTENSION);
};

Blockly.RaceroBlocks.VerticalExtensions.registerAll();
