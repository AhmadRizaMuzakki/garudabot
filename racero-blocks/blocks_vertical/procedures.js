...
/**
 * @fileoverview Procedure blocks for Racero.
 */
'use strict';

goog.provide('Blockly.RaceroBlocks.ProcedureUtils');

goog.require('Blockly.Blocks');
goog.require('Blockly.Colours');
goog.require('Blockly.constants');
goog.require('Blockly.RaceroBlocks.VerticalExtensions');
 ...
 * @this Blockly.Block
 */
Blockly.RaceroBlocks.ProcedureUtils.callerMutationToDom = function() {
 ...
 * @this Blockly.Block
 */
Blockly.RaceroBlocks.ProcedureUtils.callerDomToMutation = function(xmlElement) {
 ...
 * @this Blockly.Block
 */
Blockly.RaceroBlocks.ProcedureUtils.definitionMutationToDom = function(
    opt_generateShadows) {
  var container = document.createElement('mutation');
 ...
 * @this Blockly.Block
 */
Blockly.RaceroBlocks.ProcedureUtils.definitionDomToMutation = function(xmlElement) {
  this.procCode_ = xmlElement.getAttribute('proccode');
  this.warp_ = JSON.parse(xmlElement.getAttribute('warp'));
 ...
 * @this Blockly.Block
 */
Blockly.RaceroBlocks.ProcedureUtils.getProcCode = function() {
 ...
 * @this Blockly.Block
 */
Blockly.RaceroBlocks.ProcedureUtils.updateDisplay_ = function() {
 ...
 * @this Blockly.Block
 */
Blockly.RaceroBlocks.ProcedureUtils.disconnectOldBlocks_ = function() {
  // Remove old stuff
  var connectionMap = {};
 ...
 * @this Blockly.Block
 */
Blockly.RaceroBlocks.ProcedureUtils.removeAllInputs_ = function() {
 ...
 * @this Blockly.Block
 */
Blockly.RaceroBlocks.ProcedureUtils.createAllInputs_ = function(connectionMap) {
 ...
 * @this Blockly.Block
 */
Blockly.RaceroBlocks.ProcedureUtils.deleteShadows_ = function(connectionMap) {
 ...
 * @private
 */
Blockly.RaceroBlocks.ProcedureUtils.addLabelField_ = function(text) {
 ...
 * @private
 */
Blockly.RaceroBlocks.ProcedureUtils.addLabelEditor_ = function(text) {
  if (text) {
 ...
 * @this Blockly.Block
 */
Blockly.RaceroBlocks.ProcedureUtils.buildShadowDom_ = function(type) {
 ...
 * @this Blockly.Block
 */
Blockly.RaceroBlocks.ProcedureUtils.attachShadow_ = function(input,
    argumentType) {
 ...
 * @this Blockly.Block
 */
Blockly.RaceroBlocks.ProcedureUtils.createArgumentReporter_ = function(
 ...
 * @this Blockly.Block
 */
Blockly.RaceroBlocks.ProcedureUtils.populateArgumentOnCaller_ = function(type,
 ...
 * @this Blockly.Block
 */
Blockly.RaceroBlocks.ProcedureUtils.populateArgumentOnPrototype_ = function(
  ...
  var oldTypeMatches =
    Blockly.RaceroBlocks.ProcedureUtils.checkOldTypeMatches_(oldBlock, type);
 ...
 * @this Blockly.Block
 */
Blockly.RaceroBlocks.ProcedureUtils.populateArgumentOnDeclaration_ = function(
    type, index, connectionMap, id, input) {
 ...
 */
Blockly.RaceroBlocks.ProcedureUtils.checkOldTypeMatches_ = function(oldBlock,
    type) {
  if (!oldBlock) {
    return false;
  }
 ...
 * @this Blockly.Block
 */
Blockly.RaceroBlocks.ProcedureUtils.createArgumentEditor_ = function(
    argumentType, displayName) {
  Blockly.Events.disable();
  try {
    if (argumentType == 'n' || argumentType == 's') {
 ...
 * and their text.
 */
Blockly.RaceroBlocks.ProcedureUtils.updateDeclarationProcCode_ = function() {
  this.procCode_ = '';
  this.displayNames_ = [];
  this.argumentIds_ = [];
 ...
 * @private
 */
Blockly.RaceroBlocks.ProcedureUtils.focusLastEditor_ = function() {
 ...
 * @public
 */
Blockly.RaceroBlocks.ProcedureUtils.addLabelExternal = function() {
 ...
 * @public
 */
Blockly.RaceroBlocks.ProcedureUtils.addBooleanExternal = function() {
  Blockly.WidgetDiv.hide(true);
 ...
 * @public
 */
Blockly.RaceroBlocks.ProcedureUtils.addStringNumberExternal = function() {
  Blockly.WidgetDiv.hide(true);
 ...
 * @public
 */
Blockly.RaceroBlocks.ProcedureUtils.getWarp = function() {
  return this.warp_;
};
 ...
 * @public
 */
Blockly.RaceroBlocks.ProcedureUtils.setWarp = function(warp) {
  this.warp_ = warp;
};
 ...
 * @public
 */
Blockly.RaceroBlocks.ProcedureUtils.removeFieldCallback = function(field) {
 ...
 * @public
 */
Blockly.RaceroBlocks.ProcedureUtils.removeArgumentCallback_ = function(
    field) {
 ...
 * @this Blockly.Block
 */
Blockly.RaceroBlocks.ProcedureUtils.updateArgumentReporterNames_ = function(prevArgIds, prevDisplayNames) {
  var nameChanges = [];
  var argReporters = [];
...
Blockly.Blocks['procedures_call'] = {
  ...
  // Shared.
  getProcCode: Blockly.RaceroBlocks.ProcedureUtils.getProcCode,
  removeAllInputs_: Blockly.RaceroBlocks.ProcedureUtils.removeAllInputs_,
  disconnectOldBlocks_: Blockly.RaceroBlocks.ProcedureUtils.disconnectOldBlocks_,
  deleteShadows_: Blockly.RaceroBlocks.ProcedureUtils.deleteShadows_,
  createAllInputs_: Blockly.RaceroBlocks.ProcedureUtils.createAllInputs_,
  updateDisplay_: Blockly.RaceroBlocks.ProcedureUtils.updateDisplay_,

  // Exist on all three blocks, but have different implementations.
  mutationToDom: Blockly.RaceroBlocks.ProcedureUtils.callerMutationToDom,
  domToMutation: Blockly.RaceroBlocks.ProcedureUtils.callerDomToMutation,
  populateArgument_: Blockly.RaceroBlocks.ProcedureUtils.populateArgumentOnCaller_,
  addProcedureLabel_: Blockly.RaceroBlocks.ProcedureUtils.addLabelField_,

  // Only exists on the external caller.
  attachShadow_: Blockly.RaceroBlocks.ProcedureUtils.attachShadow_,
  buildShadowDom_: Blockly.RaceroBlocks.ProcedureUtils.buildShadowDom_
};
...
Blockly.Blocks['procedures_prototype'] = {
  ...
  // Exist on all three blocks, but have different implementations.
  mutationToDom: Blockly.RaceroBlocks.ProcedureUtils.definitionMutationToDom,
  domToMutation: Blockly.RaceroBlocks.ProcedureUtils.definitionDomToMutation,
  populateArgument_: Blockly.RaceroBlocks.ProcedureUtils.populateArgumentOnPrototype_,
  addProcedureLabel_: Blockly.RaceroBlocks.ProcedureUtils.addLabelField_,

  // Only exists on procedures_prototype.
  createArgumentReporter_: Blockly.RaceroBlocks.ProcedureUtils.createArgumentReporter_,
  updateArgumentReporterNames_: Blockly.RaceroBlocks.ProcedureUtils.updateArgumentReporterNames_
};
...
Blockly.Blocks['procedures_declaration'] = {
  ...
  mutationToDom: Blockly.RaceroBlocks.ProcedureUtils.definitionMutationToDom,
  domToMutation: Blockly.RaceroBlocks.ProcedureUtils.definitionDomToMutation,
  populateArgument_: Blockly.RaceroBlocks.ProcedureUtils.populateArgumentOnDeclaration_,
  addProcedureLabel_: Blockly.RaceroBlocks.ProcedureUtils.addLabelEditor_,

  // Exist on declaration and arguments editors, with different implementations.
  removeFieldCallback: Blockly.RaceroBlocks.ProcedureUtils.removeFieldCallback,

  // Only exist on procedures_declaration.
  createArgumentEditor_: Blockly.RaceroBlocks.ProcedureUtils.createArgumentEditor_,
  focusLastEditor_: Blockly.RaceroBlocks.ProcedureUtils.focusLastEditor_,
  getWarp: Blockly.RaceroBlocks.ProcedureUtils.getWarp,
  setWarp: Blockly.RaceroBlocks.ProcedureUtils.setWarp,
  addLabelExternal: Blockly.RaceroBlocks.ProcedureUtils.addLabelExternal,
  addBooleanExternal: Blockly.RaceroBlocks.ProcedureUtils.addBooleanExternal,
  addStringNumberExternal: Blockly.RaceroBlocks.ProcedureUtils.addStringNumberExternal,
  onChangeFn: Blockly.RaceroBlocks.ProcedureUtils.updateDeclarationProcCode_
};
...
Blockly.Blocks['argument_editor_boolean'] = {
  ...
  // Exist on declaration and arguments editors, with different implementations.
  removeFieldCallback: Blockly.RaceroBlocks.ProcedureUtils.removeArgumentCallback_
};
