...
Blockly.BlockDragger.prototype.endBlockDrag = function(e, currentDragDeltaXY) {
  ...
  // Racero-specific: note possible illegal definition deletion for rollback below.
  ...
  if (isOutside) {
    ...
    // Reset a drag to outside of racero-blocks
    setTimeout(function() {
      ws.undo();
    });
  }

  // Racero-specific: roll back deletes that create call blocks with defines.
