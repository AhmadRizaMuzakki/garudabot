 ...
 * @param {Blockly.WorkspaceComment | Blockly.RaceroBlockComment} comment
 ...
 * @return {?(Blockly.WorkspaceComment | Blockly.RaceroBlockComment)}
...
Blockly.Events.CommentMove = function(comment) {
   ...
   * location.
   * @type {?Blockly.WorkspaceComment | Blockly.RaceroBlockComment}
   */
...
Blockly.Events.CommentMove.prototype.currentLocation_ = function() {
  ...
  var rtlAwareX;
  if (this.comment_ instanceof Blockly.RaceroBlockComment) {
...
Blockly.Events.CommentMove.prototype.run = function(forward) {
  ...
  if (comment instanceof Blockly.RaceroBlockComment) {
