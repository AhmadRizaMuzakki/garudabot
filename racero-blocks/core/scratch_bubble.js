...
goog.provide('Blockly.RaceroBubble');
...
/**
 * Class for Racero comment UI bubble.
 * @param {!Blockly.RaceroBlockComment} comment The comment this bubble belongs
 *     to.
 ...
 * @constructor
 */
Blockly.RaceroBubble = function(comment, workspace, content, anchorXY,
    bubbleWidth, bubbleHeight, bubbleX, bubbleY, minimized) {

  // Needed for Events
  /**
   * The comment this bubble belongs to.
   * @type {Blockly.RaceroBlockComment}
   * @package
   */
  ...
  if (!bubbleWidth || !bubbleHeight) {
    ...
    bubbleWidth = bBox.width + 2 * Blockly.RaceroBubble.BORDER_WIDTH;
    bubbleHeight = bBox.height + 2 * Blockly.RaceroBubble.BORDER_WIDTH;
  }
...
goog.inherits(Blockly.RaceroBubble, Blockly.Bubble);

/**
 * Width of the border around the bubble.
 * @package
 */
Blockly.RaceroBubble.BORDER_WIDTH = 1;
 ...
 * @private
 */
Blockly.RaceroBubble.LINE_THICKNESS = 1;

/**
 * The height of the comment top bar.
 * @package
 */
Blockly.RaceroBubble.TOP_BAR_HEIGHT = 32;

/**
 * The size of the minimize arrow icon in the comment top bar.
 * @private
 */
Blockly.RaceroBubble.MINIMIZE_ICON_SIZE = 32;

/**
 * The size of the delete icon in the comment top bar.
 * @private
 */
Blockly.RaceroBubble.DELETE_ICON_SIZE = 32;

/**
 * The inset for the top bar icons.
 * @private
 */
Blockly.RaceroBubble.TOP_BAR_ICON_INSET = 0;
 ...
 * @private
 */
Blockly.RaceroBubble.RESIZE_SIZE = 16;
 ...
 * @private
 */
Blockly.RaceroBubble.RESIZE_CORNER_PAD = 4;
 ...
 * @private
 */
Blockly.RaceroBubble.RESIZE_OUTER_PAD = 8;
 ...
 * @private
 */
Blockly.RaceroBubble.prototype.createDom_ = function(content, hasResize, minimized) {
  ...
  this.bubbleBack_ = Blockly.utils.createSvgElement('rect',
      {
        ...
        'x': 0,
        'y': 0,
        'rx': 4 * Blockly.RaceroBubble.BORDER_WIDTH,
        'ry': 4 * Blockly.RaceroBubble.BORDER_WIDTH
      },
      this.bubbleGroup_);
 ...
 * @private
 */
Blockly.RaceroBubble.prototype.createCommentTopBar_ = function() {
  this.commentTopBar_ = Blockly.utils.createSvgElement('rect',
      {
        'class': 'blocklyDraggable scratchCommentTopBar',
        'rx': Blockly.RaceroBubble.BORDER_WIDTH,
        'ry': Blockly.RaceroBubble.BORDER_WIDTH,
        'height': Blockly.RaceroBubble.TOP_BAR_HEIGHT
      }, this.bubbleGroup_);
 ...
 * @private
 */
Blockly.RaceroBubble.prototype.createTopBarIcons_ = function() {
  var topBarMiddleY = (Blockly.RaceroBubble.TOP_BAR_HEIGHT / 2) +
      Blockly.RaceroBubble.BORDER_WIDTH;

  // Minimize Toggle Icon in Comment Top Bar
  var xInset = Blockly.RaceroBubble.TOP_BAR_ICON_INSET;
  this.minimizeArrow_ = Blockly.utils.createSvgElement('image',
      {
        'x': xInset,
        'y': topBarMiddleY - Blockly.RaceroBubble.MINIMIZE_ICON_SIZE / 2,
        'width': Blockly.RaceroBubble.MINIMIZE_ICON_SIZE,
        'height': Blockly.RaceroBubble.MINIMIZE_ICON_SIZE
      }, this.bubbleGroup_);
  ...
  this.deleteIcon_ = Blockly.utils.createSvgElement('image',
      {
        'x': xInset,
        'y': topBarMiddleY - Blockly.RaceroBubble.DELETE_ICON_SIZE / 2,
        'width': Blockly.RaceroBubble.DELETE_ICON_SIZE,
        'height': Blockly.RaceroBubble.DELETE_ICON_SIZE
      }, this.bubbleGroup_);
 ...
 * @private
 */
Blockly.RaceroBubble.prototype.createTopBarLabel_ = function() {
  this.topBarLabel_ = Blockly.utils.createSvgElement('text',
      {
        'class': 'scratchCommentText',
        'x': this.width_ / 2,
        'y': (Blockly.RaceroBubble.TOP_BAR_HEIGHT / 2) + Blockly.RaceroBubble.BORDER_WIDTH,
        'text-anchor': 'middle',
 ...
 * @private
 */
Blockly.RaceroBubble.prototype.createResizeHandle_ = function() {
  this.resizeGroup_ = Blockly.utils.createSvgElement('g',
      {'class': this.workspace_.RTL ?
                'scratchCommentResizeSW' : 'scratchCommentResizeSE'},
      this.bubbleGroup_);
  var resizeSize = Blockly.RaceroBubble.RESIZE_SIZE;
  var outerPad = Blockly.RaceroBubble.RESIZE_OUTER_PAD;
  var cornerPad = Blockly.RaceroBubble.RESIZE_CORNER_PAD;
...
/**
  ...
  * @private
  */
Blockly.RaceroBubble.prototype.showContextMenu_ = function(e) {
 ...
 * @private
 */
Blockly.RaceroBubble.prototype.minimizeArrowMouseDown_ = function(e) {
 ...
 * @private
 */
Blockly.RaceroBubble.prototype.minimizeArrowMouseOut_ = function(_e) {
 ...
 * @private
 */
Blockly.RaceroBubble.prototype.minimizeArrowMouseUp_ = function(e) {
 ...
 * @private
 */
Blockly.RaceroBubble.prototype.deleteMouseDown_ = function(e) {
 ...
 * @private
 */
Blockly.RaceroBubble.prototype.deleteMouseOut_ = function(_e) {
 ...
 * @private
 */
Blockly.RaceroBubble.prototype.deleteMouseUp_ = function(e) {
 ...
 * @private
 */
Blockly.RaceroBubble.prototype.resizeMouseDown_ = function(e) {
  this.resizeStartSize_ = {width: this.width_, height: this.height_};
  this.workspace_.setResizesEnabled(false);
  Blockly.RaceroBubble.superClass_.resizeMouseDown_.call(this, e);
};
 ...
 * @private
 */
Blockly.RaceroBubble.prototype.resizeMouseUp_ = function(_e) {
 ...
 * @package
 */
Blockly.RaceroBubble.prototype.setMinimized = function(minimize, labelText) {
 ...
 * @package
 */
Blockly.RaceroBubble.prototype.registerMinimizeToggleEvent = function(callback) {
 ...
 * @package
 */
Blockly.RaceroBubble.prototype.registerDeleteEvent = function(callback) {
 ...
 * @package
 */
Blockly.RaceroBubble.prototype.registerContextMenuCallback = function(callback) {
 ...
 * @package
 */
Blockly.RaceroBubble.prototype.setAnchorLocation = function(xy) {
  this.anchorXY_ = xy;
  if (this.rendered_) {
    this.positionBubble_();
  }
 ...
 * @package
 */
Blockly.RaceroBubble.prototype.moveTo = function(x, y) {
  Blockly.RaceroBubble.superClass_.moveTo.call(this, x, y);
 ...
 * @package
 */
Blockly.RaceroBubble.prototype.setBubbleSize = function(width, height) {
  var doubleBorderWidth = 2 * Blockly.RaceroBubble.BORDER_WIDTH;
  // Minimum size of a bubble.
  width = Math.max(width, doubleBorderWidth + 50);
  height = Math.max(height, Blockly.RaceroBubble.TOP_BAR_HEIGHT);
  this.width_ = width;
  this.height_ = height;
  this.bubbleBack_.setAttribute('width', width);
  this.bubbleBack_.setAttribute('height', height);
  this.commentTopBar_.setAttribute('width', width);
  this.commentTopBar_.setAttribute('height', Blockly.RaceroBubble.TOP_BAR_HEIGHT);
  if (this.workspace_.RTL) {
    this.minimizeArrow_.setAttribute('x', width -
        (Blockly.RaceroBubble.MINIMIZE_ICON_SIZE) -
        Blockly.RaceroBubble.TOP_BAR_ICON_INSET);
  } else {
    this.deleteIcon_.setAttribute('x', width -
        Blockly.RaceroBubble.DELETE_ICON_SIZE -
        Blockly.RaceroBubble.TOP_BAR_ICON_INSET);
  }
  if (this.resizeGroup_) {
    var resizeSize = Blockly.RaceroBubble.RESIZE_SIZE;
 ...
 * @private
 */
Blockly.RaceroBubble.prototype.renderArrow_ = function() {
  // Find the relative coordinates of the top bar center of the bubble.
  var relBubbleX = this.width_ / 2;
  var relBubbleY = Blockly.RaceroBubble.TOP_BAR_HEIGHT / 2;
  ...
  if (relBubbleX != relAnchorX || relBubbleY != relAnchorY) {
    ...
    this.bubbleArrow_.setAttribute('stroke-width', Blockly.RaceroBubble.LINE_THICKNESS);
  }
};
 ...
 * @package
 */
Blockly.RaceroBubble.prototype.setColour = function(hexColour) {
 ...
 * @package
 */
Blockly.RaceroBubble.prototype.moveDuringDrag = function(dragSurface, newLoc) {
  if (dragSurface) {
 ...
 * @private
 */
Blockly.RaceroBubble.prototype.updatePosition_ = function(x, y) {
 ...
 * @package
 */
Blockly.RaceroBubble.prototype.dispose = function() {
  Blockly.RaceroBubble.superClass_.dispose.call(this);
