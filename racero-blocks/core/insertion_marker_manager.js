...
Blockly.InsertionMarkerManager = function(block) {
   ...
   * This is the racero-blocks equivalent of connection highlighting.
   * @type {Blockly.BlockSvg}
   * @private
   */
   ...
   * This is part of the racero-blocks equivalent of connection highlighting.
   * @type {Blockly.RenderedConnection}
   * @private
   */
 ...
 * Racero-specific code, where "highlighting" applies to a block rather than
 * a connection.
 */
