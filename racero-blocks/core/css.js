...
Blockly.Css.CONTENT = [
  ...
  */
  ...
  /* Flat gray track + white thumb (avoid OS "two-tone" range fill). */
  '.blocklyNumberSlider {',
    'display: block;',
    'width: 140px;',
    'height: 22px;',
    ...
    'appearance: none;',
  '}',
  '.blocklyNumberSlider:focus {',
    'outline: none;',
  '}',
  '.blocklyNumberSlider::-webkit-slider-runnable-track {',
    'height: 6px;',
    'border-radius: 3px;',
    'background: #E9EEF2;',
    'border: none;',
  '}',
  '.blocklyNumberSlider::-webkit-slider-thumb {',
    '-webkit-appearance: none;',
    'appearance: none;',
    'width: 18px;',
    'height: 18px;',
  ...
  '}',
  '.blocklyNumberSlider::-moz-range-track {',
    'height: 6px;',
    'border-radius: 3px;',
    'background: #E9EEF2;',
    'border: none;',
  '}',
  '.blocklyNumberSlider::-moz-range-thumb {',
    'width: 18px;',
    'height: 18px;',
    'border-radius: 50%;',
    'background: #FFFFFF;',
    ...
    'box-shadow: 0 1px 2px rgba(0,0,0,0.15);',
  '}',
  '.blocklyNumberSlider::-moz-range-progress {',
    'background: transparent;',
  '}',
