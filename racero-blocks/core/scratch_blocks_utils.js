...
/**
 * @fileoverview Utility methods for Racero Blocks but not Blockly.
 ...
 * Racero specific to help the VM handle deleting obscured shadows.
 ...
 * blocks have special behaviour in racero-blocks: they're duplicated when
 ...
 * option in Racero Blocks.  The block is duplicated and attached to the mouse,
...
Blockly.scratchBlocksUtils.duplicateAndDragCallback = function(oldBlock, event) {
  ...
  return function(e) {
    ...
    setTimeout(function() {
      ...
      // positioned and has had its shadow IDs fixed (Racero-specific).
      ...
      try {
        ...
        // Racero-specific: Give shadow dom new IDs to prevent duplicating on paste
