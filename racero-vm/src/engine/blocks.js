 ...
 * and handle updates from Racero Blocks events.
 */
...
class Blocks {
        ...
        case 'comment_create':
            if (this.runtime.getEditingTarget()) {
                ...
                if (currTarget.comments[e.commentId].x === null &&
                    ...
                    // x and y coordinates set to null so that racero-blocks can
     ...
     * by a Blockly/racero-blocks workspace.
     ...
     * into a Blockly/racero-blocks XML string.
