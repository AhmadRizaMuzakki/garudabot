...
/**
 * Class for the translate block in Racero 3.0.
 * @constructor
 */
class Racero3TranslateBlocks {
    constructor () {
        /**
    ...
    getViewerLanguage () {
        ...
        // code instead of Racero's (e.g. for es-419 we look up es to get espanol)
    ...
    getLanguageCodeFromArg (arg) {
        ...
        // There are some languages we launched in the language menu that Racero did not
...
module.exports = Racero3TranslateBlocks;
