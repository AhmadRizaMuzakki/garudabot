...
const RaceroLinkDeviceAdapter = require('./scratch-link-device-adapter');
...
/**
 * Manage communication with a GDX-FOR peripheral over a Racero Link client socket.
 */
class GdxFor {
     ...
     */
    _onConnect () {
        const adapter = new RaceroLinkDeviceAdapter(this._ble, BLEUUID);
...
/**
 * Racero 3.0 blocks to interact with a GDX-FOR peripheral.
 */
class Racero3GdxForBlocks {
    ...
    constructor (runtime) {
        ...
        this._peripheral = new GdxFor(this.runtime, Racero3GdxForBlocks.EXTENSION_ID);
    }
    ...
    getInfo () {
        return {
            id: Racero3GdxForBlocks.EXTENSION_ID,
            name: Racero3GdxForBlocks.EXTENSION_NAME,
...
module.exports = Racero3GdxForBlocks;
