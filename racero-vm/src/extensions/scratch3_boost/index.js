...
class BoostMotor {
    ...
    constructor (parent, index) {
         ...
         * that will be called once Racero VM gets a notification from the Move Hub.
         * @type {Object}
         * @private
         */
...
/**
 * Racero 3.0 blocks to interact with a LEGO Boost peripheral.
 */
class Racero3BoostBlocks {
    ...
    constructor (runtime) {
        ...
        this._peripheral = new Boost(this.runtime, Racero3BoostBlocks.EXTENSION_ID);
    }
    ...
    getInfo () {
        return {
            id: Racero3BoostBlocks.EXTENSION_ID,
            name: 'BOOST',
    ...
    _isTilted (direction) {
        ...
        case BoostTiltDirection.ANY:
            return (Math.abs(this._peripheral.tiltX) >= Racero3BoostBlocks.TILT_THRESHOLD) ||
                (Math.abs(this._peripheral.tiltY) >= Racero3BoostBlocks.TILT_THRESHOLD);
        default:
            return this._getTiltAngle(direction) >= Racero3BoostBlocks.TILT_THRESHOLD;
        }
    }
...
module.exports = Racero3BoostBlocks;
