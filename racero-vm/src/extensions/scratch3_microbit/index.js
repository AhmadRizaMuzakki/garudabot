...
/**
 * Racero 3.0 blocks to interact with a MicroBit peripheral.
 */
class Racero3MicroBitBlocks {
    ...
    constructor (runtime) {
        ...
        this._peripheral = new MicroBit(this.runtime, Racero3MicroBitBlocks.EXTENSION_ID);
    }
    ...
    getInfo () {
        return {
            id: Racero3MicroBitBlocks.EXTENSION_ID,
            name: Racero3MicroBitBlocks.EXTENSION_NAME,
    ...
    _isTilted (direction) {
        ...
        case MicroBitTiltDirection.ANY:
            return (Math.abs(this._peripheral.tiltX / 10) >= Racero3MicroBitBlocks.TILT_THRESHOLD) ||
                (Math.abs(this._peripheral.tiltY / 10) >= Racero3MicroBitBlocks.TILT_THRESHOLD);
        default:
            return this._getTiltAngle(direction) >= Racero3MicroBitBlocks.TILT_THRESHOLD;
        }
    }
...
module.exports = Racero3MicroBitBlocks;
