...
class WeDo2 {
    ...
    constructor (runtime, extensionId) {
        ...
        /**
         * The Racero 3.0 runtime used to trigger the green flag button.
         * @type {Runtime}
         * @private
         */
         ...
         * over the socket to Racero Link to a maximum number of sends per second.
         * @type {RateLimiter}
         * @private
         */
...
/**
 * Racero 3.0 blocks to interact with a LEGO WeDo 2.0 peripheral.
 */
class Racero3WeDo2Blocks {
     ...
     * @param {Runtime} runtime - the Racero 3.0 runtime.
     */
    constructor (runtime) {
        /**
         * The Racero 3.0 runtime.
         * @type {Runtime}
         */
        this.runtime = runtime;

        // Create a new WeDo 2.0 peripheral instance
        this._peripheral = new WeDo2(this.runtime, Racero3WeDo2Blocks.EXTENSION_ID);
    }
    ...
    getInfo () {
        return {
            id: Racero3WeDo2Blocks.EXTENSION_ID,
            name: 'WeDo 2.0',
    ...
    _isTilted (direction) {
        ...
        case WeDo2TiltDirection.ANY:
            return this._getTiltAngle(WeDo2TiltDirection.UP) >= Racero3WeDo2Blocks.TILT_THRESHOLD ||
                this._getTiltAngle(WeDo2TiltDirection.DOWN) >= Racero3WeDo2Blocks.TILT_THRESHOLD ||
                this._getTiltAngle(WeDo2TiltDirection.LEFT) >= Racero3WeDo2Blocks.TILT_THRESHOLD ||
                this._getTiltAngle(WeDo2TiltDirection.RIGHT) >= Racero3WeDo2Blocks.TILT_THRESHOLD;
        default:
            return this._getTiltAngle(direction) >= Racero3WeDo2Blocks.TILT_THRESHOLD;
        }
    }
...
module.exports = Racero3WeDo2Blocks;
