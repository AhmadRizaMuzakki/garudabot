...
/**
 * Class for the makey makey blocks in Racero 3.0
 * @constructor
 */
class Racero3MakeyMakeyBlocks {
    constructor (runtime) {
        /**
    ...
    */
     ...
     */
    keyPressed (key) {
        // Store only the first word of the Racero key name, so that e.g. when
...
module.exports = Racero3MakeyMakeyBlocks;
