...
/**
 * Enum for Ev3 device labels used in the Racero blocks/UI.
 * @readonly
 * @enum {string}
 */
const Ev3Label = {
...
class Racero3Ev3Blocks {
    ...
    constructor (runtime) {
        ...
        this._peripheral = new EV3(this.runtime, Racero3Ev3Blocks.EXTENSION_ID);
    ...
    getInfo () {
        return {
            id: Racero3Ev3Blocks.EXTENSION_ID,
            name: 'LEGO EV3',
...
module.exports = Racero3Ev3Blocks;
