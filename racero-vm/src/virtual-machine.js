...
class VirtualMachine extends EventEmitter {
    ...
    /**
     * Load a Racero project from a .sb, .sb2, .sb3 or json string.
            ...
            .catch(error => {
                ...
                try {
                    ...
                    if (sb1Error instanceof ValidationError) {
                        // The input does not validate as a Racero 1 file.
                    } else {
                        // The project appears to be a Racero 1 file but it
                        // could not be successfully translated into a Racero 2
                        // project.
    ...
    /**
     * Load a project from the Racero web site, by ID.
    ...
    /**
     * @returns {string} Project in a Racero 3.0 JSON representation.
     */
    saveProjectSb3 () {
    ...
    /**
     * Export project or sprite as a Racero 3.0 JSON representation.
    ...
    // a breaking change.
    /**
     * Load a project from a Racero JSON representation.
    ...
    deserializeProject (projectJSON, zip) {
        ...
        if (typeof performance !== 'undefined') {
            performance.mark('racero-vm-deserialize-start');
        }
        ...
        const deserializePromise = function () {
            ...
            return Promise.reject('Unable to verify Racero Project version.');
        };
        return deserializePromise()
            .then(({targets, extensions}) => {
                if (typeof performance !== 'undefined') {
                    performance.mark('racero-vm-deserialize-end');
                    performance.measure('racero-vm-deserialize',
                        'racero-vm-deserialize-start', 'racero-vm-deserialize-end');
                }
    ...
    /**
     * Emit an Blockly/racero-blocks compatible XML representation
    ...
    /**
     * Allow VM consumer to configure the RaceroLink socket creator.
     * @param {Function} factory The custom RaceroLink socket factory.
     */
    configureRaceroLinkSocketFactory (factory) {
        this.runtime.configureRaceroLinkSocketFactory(factory);
    }
}
