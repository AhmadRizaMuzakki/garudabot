/**
 * This class provides a RaceroLinkSocket implementation using WebSockets,
 * attempting to connect with the locally installed Racero-Link.
 *
 * To connect with RaceroLink without WebSockets, you must implement all of the
...
class RaceroLinkWebSocket {
    ...
    open () {
        ...
        case 'BT':
            ...
            break;
        default:
            throw new Error(`Unknown RaceroLink socket Type: ${this._type}`);
        }
...
module.exports = RaceroLinkWebSocket;
