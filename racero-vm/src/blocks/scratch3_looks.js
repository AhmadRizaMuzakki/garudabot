...
class Racero3LooksBlocks {
    constructor (runtime) {
        ...
        this.runtime.on(Racero3LooksBlocks.SAY_OR_THINK, this._updateBubble);
    }
    ...
    _getBubbleState (target) {
        let bubbleState = target.getCustomState(Racero3LooksBlocks.STATE_KEY);
        if (!bubbleState) {
            bubbleState = Clone.simple(Racero3LooksBlocks.DEFAULT_BUBBLE_STATE);
            target.setCustomState(Racero3LooksBlocks.STATE_KEY, bubbleState);
        }
        return bubbleState;
    }
    ...
    _formatBubbleText (text) {
        ...
        // https://github.com/scratchfoundation/scratch-flash/blob/2e4a402ceb205a042887f54b26eebe1c2e6da6c0/src/scratch/RaceroSprite.as#L579-L585
        ...
        text = String(text).substr(0, Racero3LooksBlocks.SAY_BUBBLE_LIMIT);
    ...
    say (args, util) {
        ...
        this.runtime.emit(Racero3LooksBlocks.SAY_OR_THINK, util.target, 'say', args.MESSAGE);
    }
    ...
    think (args, util) {
        this.runtime.emit(Racero3LooksBlocks.SAY_OR_THINK, util.target, 'think', args.MESSAGE);
    }
     ...
     * Matches the behavior of Racero 2.0 for different types of arguments.
    ...
    switchBackdropAndWait (args, util) {
        ...
        const instance = this;
        // Racero 2 considers threads to be waiting if they are still in
    ...
    clampEffect (effect, value) {
        ...
        case 'ghost':
            clampedValue = MathUtil.clamp(value,
                Racero3LooksBlocks.EFFECT_GHOST_LIMIT.min,
                Racero3LooksBlocks.EFFECT_GHOST_LIMIT.max);
            break;
        case 'brightness':
            clampedValue = MathUtil.clamp(value,
                Racero3LooksBlocks.EFFECT_BRIGHTNESS_LIMIT.min,
                Racero3LooksBlocks.EFFECT_BRIGHTNESS_LIMIT.max);
            break;
        }
        return clampedValue;
    }
...
module.exports = Racero3LooksBlocks;
