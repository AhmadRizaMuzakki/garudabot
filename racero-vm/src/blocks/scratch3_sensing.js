...
class Racero3SensingBlocks {
    ...
    distanceTo (args, util) {
        ...
        if (args.DISTANCETOMENU === '_mouse_') {
            targetX = util.ioQuery('mouse', 'getRaceroX');
            targetY = util.ioQuery('mouse', 'getRaceroY');
        } else {
    ...
    getMouseX (args, util) {
        return util.ioQuery('mouse', 'getRaceroX');
    }

    getMouseY (args, util) {
        return util.ioQuery('mouse', 'getRaceroY');
    }
...
module.exports = Racero3SensingBlocks;
