 ...
 * and here:
 * https://github.com/scratchfoundation/racero-blocks/tree/develop/blocks_vertical
 * (for the new opcodes and argument names).
 * and here:
 * https://github.com/scratchfoundation/racero-blocks/blob/develop/tests/
 ...
 * @property {string} opcode - the Racero 3.0 block opcode. Use 'extensionID.opcode' for extension opcodes.
 ...
 * @property {string} inputOp - the racero-blocks shadow type for this arg
 * @property {string} inputName - the name this argument will take when provided to the block implementation
 */

/**
 * Mapping of Racero 2.0 opcode to Racero 3.0 block metadata.
...
const specMap = {
    ...
    // Racero 2 uses this alternative variable getter opcode only in monitors,
...
/**
 * Add to the specMap entries for an opcode from a Racero 2.0 extension. Two entries will be made with the same
 * metadata; this is done to support projects saved by both older and newer versions of the Racero 2.0 editor.
 * @param {string} sb2Extension - the Racero 2.0 name of the extension
 * @param {string} sb2Opcode - the Racero 2.0 opcode
 * @param {SB2SpecMap_blockInfo} blockInfo - the Racero 3.0 block info
 */
const addExtensionOp = function (sb2Extension, sb2Opcode, blockInfo) {
    /**
     * This string separates the name of an extension and the name of an opcode in more recent Racero 2.0 projects.
     * Earlier projects used '.' as a separator, up until we added the 'LEGO WeDo 2.0' extension...
     * @type {string}
     */
    const sep = '\u001F'; // Unicode Unit Separator

    // make one entry for projects saved by recent versions of the Racero 2.0 editor
    specMap[`${sb2Extension}${sep}${sb2Opcode}`] = blockInfo;

    // make a second for projects saved by older versions of the Racero 2.0 editor
