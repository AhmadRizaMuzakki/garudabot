...
const deserializeCostume = function (costume, runtime, zip, assetFileName, textLayerFileName) {
    ...
    // textLayerMD5 exists if there is a text layer, which is a png of text from Racero 1.4
    // that was opened in Racero 2.0. In this case, set costume.textLayerAsset.
