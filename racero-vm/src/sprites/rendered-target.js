...
class RenderedTarget extends Target {
    ...
    constructor (sprite, runtime) {
        ...
        /**
         * Whether this rendered target represents the Racero stage.
         * @type {boolean}
         */
        this.isStage = false;

        /**
         * Racero X coordinate. Currently should range from -240 to 240.
         * @type {Number}
         */
        this.x = 0;

        /**
         * Racero Y coordinate. Currently should range from -180 to 180.
         * @type {number}
         */
        this.y = 0;

        /**
         * Racero direction. Currently should range from -179 to 180.
         * @type {number}
         */
        this.direction = 90;
     ...
     * @param {!number} x New X coordinate, in Racero coordinates.
     * @param {!number} y New Y coordinate, in Racero coordinates.
    ...
    setSize (size) {
        ...
        if (this.renderer) {
            ...
            // See original RaceroSprite.as:setSize.
     ...
     * Includes top, left, bottom, right attributes in Racero coordinates.
    ...
    isTouchingSprite (spriteName) {
        ...
        // by other sprites while it is being dragged. This matches Racero 2.0 behavior.
