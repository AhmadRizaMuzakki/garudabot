...
const RaceroBlocksConstants = require('../../src/engine/racero-blocks-constants');
...
const testReporter = function (t, reporter) {
    ...
    t.equal(reporter.json.outputShape, RaceroBlocksConstants.OUTPUT_SHAPE_ROUND);
...
const testInlineImage = function (t, inlineImage) {
    ...
    t.equal(inlineImage.json.outputShape, RaceroBlocksConstants.OUTPUT_SHAPE_ROUND);
...
const testCommand = function (t, command) {
    ...
    t.equal(command.json.outputShape, RaceroBlocksConstants.OUTPUT_SHAPE_SQUARE);
...
const testConditional = function (t, conditional) {
    ...
    t.equal(conditional.json.outputShape, RaceroBlocksConstants.OUTPUT_SHAPE_SQUARE);
...
const testLoop = function (t, loop) {
    ...
    t.equal(loop.json.outputShape, RaceroBlocksConstants.OUTPUT_SHAPE_SQUARE);
