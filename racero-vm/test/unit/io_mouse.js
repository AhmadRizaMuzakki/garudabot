...
test('spec', t => {
    ...
    t.type(m.getRaceroX, 'function');
    t.type(m.getRaceroY, 'function');
...
test('mouseUp', t => {
    ...
    t.strictEquals(m.getRaceroX(), -240);
    t.strictEquals(m.getRaceroY(), 170);
...
test('mouseDown', t => {
    ...
    t.strictEquals(m.getRaceroX(), -230);
    t.strictEquals(m.getRaceroY(), -180);
...
test('at zoomed scale', t => {
    ...
    t.strictEquals(m.getRaceroX(), -120);
    t.strictEquals(m.getRaceroY(), -90);
    t.end();
});
