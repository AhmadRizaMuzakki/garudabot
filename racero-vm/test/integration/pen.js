...
const Racero3PenBlocks = require('../../src/extensions/scratch3_pen/index.js');
...
test('pen', t => {
    ...
    vm.on('playgroundData', () => {
        ...
        /** @type {PenState} */
        const originalPenState = originalCat.getCustomState(Racero3PenBlocks.STATE_KEY);

        /** @type {PenState} */
        const clonePenState = cloneCat.getCustomState(Racero3PenBlocks.STATE_KEY);
