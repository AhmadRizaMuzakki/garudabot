...
class MockBlock {
    constructor (blockInfo, extendedOpcode) {
        ...
        const prototype = defineDynamicBlock(MockRaceroBlocks, categoryInfo, blockInfo, extendedOpcode);
...
describe('defineDynamicBlock', () => {
    ...
    test('can define a command block with an icon', () => {
        ...
        expect(block.result).toEqual({
            ...
            inputsInline: true,
            nextConnection: true,
            outputShape_: MockRaceroBlocks.OUTPUT_SHAPE_SQUARE,
    ...
    test('can define a reporter', () => {
        ...
        expect(block.result).toEqual({
            ...
            outputShape_: MockRaceroBlocks.OUTPUT_SHAPE_ROUND, // reporter
    ...
    test('can define a Boolean', () => {
        ...
        expect(block.result).toEqual({
            ...
            // nextConnection: undefined, // reporter
            outputConnection: true, // reporter
            outputShape_: MockRaceroBlocks.OUTPUT_SHAPE_HEXAGONAL, // Boolean
            // previousConnection: undefined, // reporter
            type: extendedOpcode
        });
    });
