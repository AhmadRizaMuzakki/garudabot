...
WeRGBLed::WeRGBLed(uint8_t pin){
    ...
    {
      numLEDs = DEFAULT_MAX_LED_NUMBER;
    }
...
void WeRGBLed::setColor(uint16_t n, uint8_t red, uint8_t green, uint8_t blue) {
    if(n == 0) {
...
void WeRGBLed::setColor(uint16_t n,  long value) {
