...
import ArgumentType from 'racero-vm/src/extension-support/argument-type';
import BlockType from 'racero-vm/src/extension-support/block-type';
 ...
 * @param {object} RaceroBlocks - The RaceroBlocks name space.
 ...
 */
// TODO: grow this until it can fully replace `_convertForRaceroBlocks` in the VM runtime
const defineDynamicBlock = (RaceroBlocks, categoryInfo, staticBlockInfo, extendedOpcode) => ({
    init: function () {
        const blockJson = {
            type: extendedOpcode,
            inputsInline: true,
        ...
        // There is a racero-blocks / Blockly extension called "scratch_extension" which adjusts the styling of
        // blocks to allow for an icon, a feature of Racero extension blocks. However, Racero "core" extension
        // blocks don't have icons and so they should not use 'scratch_extension'. Adding a racero-blocks / Blockly
    ...
    domToMutation: function (xmlElement) {
        ...
        case BlockType.LOOP:
            this.setOutputShape(RaceroBlocks.OUTPUT_SHAPE_SQUARE);
            this.setPreviousStatement(true);
            this.setNextStatement(!blockInfo.isTerminal);
            break;
        case BlockType.REPORTER:
            this.setOutput(true);
            this.setOutputShape(RaceroBlocks.OUTPUT_SHAPE_ROUND);
        ...
        case BlockType.BOOLEAN:
            this.setOutput(true);
            this.setOutputShape(RaceroBlocks.OUTPUT_SHAPE_HEXAGONAL);
            break;
        case BlockType.HAT:
