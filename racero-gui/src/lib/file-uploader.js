 ...
 * @param {RaceroStorage} storage The storage to cache the asset in
 * @param {AssetType} assetType A RaceroStorage AssetType indicating what kind of
 * asset this is.
 ...
 * @param {RaceroStorage} storage The RaceroStorage instance to cache the costume data
 ...
 * @param {RaceroStorage} storage The RaceroStorage instance to cache the sound data
