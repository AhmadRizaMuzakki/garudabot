const musicIcon        = require('./extensions/musicIcon.svg');
const penIcon          = require('./extensions/penIcon.svg');
const text2speechIcon  = require('./extensions/text2speechIcon.svg');
const translateIcon    = require('./extensions/translateIcon.svg');
const videoSensingIcon = require('./extensions/videoSensingIcon.svg');
