...
export default function (blockId) {
    // Not sure any better way to access the racero-blocks workspace than this...
    const block = RaceroBlocks.getMainWorkspace().getBlockById(blockId);
    ...
    return new Promise(resolve => {
        setTimeout(() => {
            ...
            computedStyleToInlineStyle(svg, {
                ...
                // Specifically properties that are set from CSS in racero-blocks
