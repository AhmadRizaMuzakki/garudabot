...
const vmListenerHOC = function (WrappedComponent) {
    ...
    const mapStateToProps = state => ({
        projectChanged: state.raceroGui.projectChanged,
        ...
        shouldUpdateTargets: !state.raceroGui.mode.isFullScreen && !state.raceroGui.mode.isPlayerOnly &&
            !state.raceroGui.modals.soundRecorder,
        // Do not update the projectChanged state in fullscreen or player only mode
        shouldUpdateProjectChanged: !state.raceroGui.mode.isFullScreen && !state.raceroGui.mode.isPlayerOnly,
