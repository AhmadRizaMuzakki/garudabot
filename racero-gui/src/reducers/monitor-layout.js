...
const ADD_MONITOR_RECT = 'racero-gui/monitors/ADD_MONITOR_RECT';
const MOVE_MONITOR_RECT = 'racero-gui/monitors/MOVE_MONITOR_RECT';
const RESIZE_MONITOR_RECT = 'racero-gui/monitors/RESIZE_MONITOR_RECT';
const REMOVE_MONITOR_RECT = 'racero-gui/monitors/REMOVE_MONITOR_RECT';
...
// Init position --------------------------
const PADDING = 5;
// @todo fix these numbers when we fix https://github.com/LLK/racero-gui/issues/980
