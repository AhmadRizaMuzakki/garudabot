const ACTIVATE_COLOR_PICKER = 'racero-gui/color-picker/ACTIVATE_COLOR_PICKER';
const DEACTIVATE_COLOR_PICKER = 'racero-gui/color-picker/DEACTIVATE_COLOR_PICKER';
const SET_CALLBACK = 'racero-gui/color-picker/SET_CALLBACK';
