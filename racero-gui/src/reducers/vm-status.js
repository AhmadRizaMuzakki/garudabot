const SET_RUNNING_STATE = 'racero-gui/vm-status/SET_RUNNING_STATE';
const SET_TURBO_STATE = 'racero-gui/vm-status/SET_TURBO_STATE';
const SET_STARTED_STATE = 'racero-gui/vm-status/SET_STARTED_STATE';
