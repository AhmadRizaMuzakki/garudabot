...
const DONE_CREATING_COPY = 'racero-gui/project-state/DONE_CREATING_COPY';
const DONE_CREATING_NEW = 'racero-gui/project-state/DONE_CREATING_NEW';
const DONE_FETCHING_DEFAULT = 'racero-gui/project-state/DONE_FETCHING_DEFAULT';
const DONE_FETCHING_WITH_ID = 'racero-gui/project-state/DONE_FETCHING_WITH_ID';
const DONE_LOADING_VM_TO_SAVE = 'racero-gui/project-state/DONE_LOADING_VM_TO_SAVE';
const DONE_LOADING_VM_WITH_ID = 'racero-gui/project-state/DONE_LOADING_VM_WITH_ID';
const DONE_LOADING_VM_WITHOUT_ID = 'racero-gui/project-state/DONE_LOADING_VM_WITHOUT_ID';
const DONE_REMIXING = 'racero-gui/project-state/DONE_REMIXING';
const DONE_UPDATING = 'racero-gui/project-state/DONE_UPDATING';
const DONE_UPDATING_BEFORE_COPY = 'racero-gui/project-state/DONE_UPDATING_BEFORE_COPY';
const DONE_UPDATING_BEFORE_NEW = 'racero-gui/project-state/DONE_UPDATING_BEFORE_NEW';
const RETURN_TO_SHOWING = 'racero-gui/project-state/RETURN_TO_SHOWING';
const SET_PROJECT_ID = 'racero-gui/project-state/SET_PROJECT_ID';
const SET_PROJECT_PATH = 'racero-gui/project-state/SET_PROJECT_PATH';
const START_AUTO_UPDATING = 'racero-gui/project-state/START_AUTO_UPDATING';
const START_CREATING_NEW = 'racero-gui/project-state/START_CREATING_NEW';
const START_ERROR = 'racero-gui/project-state/START_ERROR';
const START_FETCHING_NEW = 'racero-gui/project-state/START_FETCHING_NEW';
const START_LOADING_VM_FILE_UPLOAD = 'racero-gui/project-state/START_LOADING_VM_FILE_UPLOAD';
const START_MANUAL_UPDATING = 'racero-gui/project-state/START_MANUAL_UPDATING';
const START_REMIXING = 'racero-gui/project-state/START_REMIXING';
const START_UPDATING_BEFORE_CREATING_COPY = 'racero-gui/project-state/START_UPDATING_BEFORE_CREATING_COPY';
const START_UPDATING_BEFORE_CREATING_NEW = 'racero-gui/project-state/START_UPDATING_BEFORE_CREATING_NEW';
