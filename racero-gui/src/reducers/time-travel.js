const SET_TIME_TRAVEL = 'racero-gui/time-travel/SET_TIME_TRAVEL';
const initialState = {
    year: 'NOW'
};
...
const isTimeTravel220022BC = function (state) {
    return state.raceroGui.timeTravel.year === YEAR_220022BC;
};
...
const isTimeTravel1920 = function (state) {
    return state.raceroGui.timeTravel.year === YEAR_1920;
};
...
const isTimeTravel1990 = function (state) {
    return state.raceroGui.timeTravel.year === YEAR_1990;
};
...
const isTimeTravel2020 = function (state) {
    return state.raceroGui.timeTravel.year === YEAR_2020;
};
...
const isTimeTravelNow = function (state) {
    return state.raceroGui.timeTravel.year === NOW;
};
