...
const SHOW_ALERT = 'racero-gui/alerts/SHOW_ALERT';
const SHOW_EXTENSION_ALERT = 'racero-gui/alerts/SHOW_EXTENSION_ALERT';
const CLOSE_ALERT = 'racero-gui/alerts/CLOSE_ALERT';
const CLOSE_ALERTS_WITH_ID = 'racero-gui/alerts/CLOSE_ALERTS_WITH_ID';
const CLOSE_ALERT_WITH_ID = 'racero-gui/alerts/CLOSE_ALERT_WITH_ID';
