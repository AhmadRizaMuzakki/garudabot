...
const CLOSE_CARDS = 'racero-gui/cards/CLOSE_CARDS';
const SHRINK_EXPAND_CARDS = 'racero-gui/cards/SHRINK_EXPAND_CARDS';
const VIEW_CARDS = 'racero-gui/cards/VIEW_CARDS';
const ACTIVATE_DECK = 'racero-gui/cards/ACTIVATE_DECK';
const NEXT_STEP = 'racero-gui/cards/NEXT_STEP';
const PREV_STEP = 'racero-gui/cards/PREV_STEP';
const DRAG_CARD = 'racero-gui/cards/DRAG_CARD';
const START_DRAG = 'racero-gui/cards/START_DRAG';
const END_DRAG = 'racero-gui/cards/END_DRAG';
