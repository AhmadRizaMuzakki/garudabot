        ...
        <div dir={props.isRtl ? 'rtl' : 'ltr'}>
            ...
            <Box className={styles.body}>
                ...
                <p>
                    ...
                    <FormattedMessage
                        defaultMessage="Unfortunately it looks like your browser or computer {webGlLink}. This technology is needed for Racero 3.0 to run."
                ...
                <div className={styles.faqLinkText}>
                    <FormattedMessage
                        ...
                        description="Racero 3.0 FAQ description"
