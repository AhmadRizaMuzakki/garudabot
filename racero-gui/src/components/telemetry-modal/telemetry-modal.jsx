...
const messages = defineMessages({
    label: {
        ...
        defaultMessage: 'Report statistics to improve Racero',
        description: 'Racero 3.0 telemetry modal label - for accessibility'
    },
    bodyText1: {
        defaultMessage: 'The Racero Team is always looking to better understand how Racero is used around the ' +
            'world. To help support this effort, you can allow Racero to automatically send usage information to ' +
            'the Racero Team.',
    ...
    privacyPolicyLink: {
        ...
        description: 'Link to the Racero privacy policy',
        id: 'gui.telemetryOptIn.privacyPolicyLink'
    },
    optInText: {
        defaultMessage: 'Share my usage data with the Racero Team',
    ...
    optOutText: {
        defaultMessage: 'Do not share my usage data with the Racero Team',
        description: 'Text for telemetry modal opt-in button',
