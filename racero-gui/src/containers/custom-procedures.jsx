...
class CustomProcedures extends React.Component {
    ...
    setBlocks (blocksRef) {
        ...
        const oldDefaultToolbox = RaceroBlocks.Blocks.defaultToolbox;
        RaceroBlocks.Blocks.defaultToolbox = null;
        this.workspace = RaceroBlocks.inject(this.blocks, workspaceConfig);
        RaceroBlocks.Blocks.defaultToolbox = oldDefaultToolbox;
        ...
        this.workspace.addChangeListener(() => {
            ...
            let dx;
            if (this.props.isRtl) {
                // // TODO: https://github.com/LLK/racero-gui/issues/2838
...
const mapStateToProps = state => ({
    ...
    mutator: state.raceroGui.customProcedures.mutator
});
