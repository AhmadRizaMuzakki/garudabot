...
import Renderer from 'scratch-render/src/index';
...
class Stage extends React.Component {
    ...
    onMouseMove (e) {
        ...
        if (this.state.mouseDown && this.state.isDragging) {
            ...
            if (this.props.useEditorDragStyle) {
                ...
                const spritePosition = this.getRaceroCoords(mousePosition[0], mousePosition[1]);
    ...
    onStartDrag (x, y) {
        ...
        const [scratchMouseX, scratchMouseY] = this.getRaceroCoords(x, y);
    ...
    onStopDrag (mouseX, mouseY) {
        ...
        if (this.props.useEditorDragStyle) {
            ...
            if (mouseX > 0 && mouseX < this.rect.width &&
                ...
                const spritePosition = this.getRaceroCoords(mouseX, mouseY);
...
const mapStateToProps = state => ({
    isColorPicking: state.raceroGui.colorPicker.active,
    isFullScreen: state.raceroGui.mode.isFullScreen,
    isStarted: state.raceroGui.vmStatus.started,
    micIndicator: state.raceroGui.micIndicator,
    // Do not use editor drag style in fullscreen or player mode.
    useEditorDragStyle: !(state.raceroGui.mode.isFullScreen || state.raceroGui.mode.isPlayerOnly)
});
