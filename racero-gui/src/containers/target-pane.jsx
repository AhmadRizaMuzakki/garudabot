...
const mapStateToProps = state => ({
    editingTarget: state.raceroGui.targets.editingTarget,
    hoveredTarget: state.raceroGui.hoveredTarget,
    isRtl: state.locales.isRtl,
    spriteLibraryVisible: state.raceroGui.modals.spriteLibrary,
    sprites: state.raceroGui.targets.sprites,
    stage: state.raceroGui.targets.stage,
    raiseSprites: state.raceroGui.blockDrag,
