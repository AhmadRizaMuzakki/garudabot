...
const mapStateToProps = (state, {soundIndex}) => {
    const sprite = state.raceroGui.vm.editingTarget.sprite;
    ...
    const sound = state.raceroGui.vm.editingTarget.sprite.sounds[index];
    const audioBuffer = state.raceroGui.vm.getSoundBuffer(index);
    return {
