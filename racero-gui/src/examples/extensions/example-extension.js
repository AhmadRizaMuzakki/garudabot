...
ExampleExtension.prototype.getInfo = function () {
    return {
        ...
        blocks: [
            {
                opcode: 'example-noop',
                blockType: Racero.BlockType.COMMAND,
            ...
            },
            {
                ...
                blockType: Racero.BlockType.CONDITIONAL,
                branchCount: 4,
                isTerminal: true,
                blockAllThreads: false,
                text: 'choose [BRANCH]',
                arguments: {
                    BRANCH: {
                        type: Racero.ArgumentType.NUMBER,
                        defaultValue: 1
                    }
                },
                func: 'noop'
            },
            {
                ...
                blockType: Racero.BlockType.REPORTER,
                ...
                arguments: {
                    ...
                    TEXT: {
                        // Required: type of the argument / shape of the block input
                        type: Racero.ArgumentType.STRING,
            ...
            },
            {
                ...
                blockType: Racero.BlockType.BOOLEAN,
                text: 'return true',
                func: 'returnTrue'
            },
            {
                opcode: 'example-hat',
                blockType: Racero.BlockType.HAT,
                text: 'after forever',
                func: 'returnFalse'
            },
            {
...
Racero.extensions.register(new ExampleExtension());
