...
const locales = require('../src/supported-locales.js').default;
    ...
    return Object.keys(locales).reduce((collection, lang) => {
        try {
            ...
            Object.keys(langData).forEach(key => {
                ...
                flattened[key] = (typeof entry === 'object' && entry.message) 
                    ? (entry.message || entry.defaultMessage || entry)
                    : entry;
            });

            collection[lang] = flattened;
        } catch (e) {
